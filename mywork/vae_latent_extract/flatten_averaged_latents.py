...
example_input_file = "/projects/prjs1914/output/vae_latent_540p_time_averaged/0001_fw_16by9_960x544_crop_540p/0001_fw_16by9_960x544_crop_540p_latent.pt"
output_dir = "/projects/prjs1914/output/vae_latent_540p_time_averaged_flattened"
input_root_dir = "/projects/prjs1914/output/vae_latent_540p_time_averaged"
...
def flatten_averaged_latent(latent_file=example_input_file):
...
def reconstruct_averaged_latent_from_flattened(flattened_latent_file):
...
def flatten_averaged_latents_for_range(start_index=1, end_index=2179):
    processed = 0
    skipped = 0
    saved_paths = []
    ...
    for video_index in range(start_index, end_index + 1):
        ...
        save_path = flatten_averaged_latent(latent_path)
...
def reconstruct_video_from_flattened_latent(flattened_latent_file):
    return reconstruct_averaged_latent_from_flattened(flattened_latent_file)